    ...
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex">
      ...
      <div className='absolute right-0 top-8'>
        <div className='flex justify-between p-4 rounded -mt-3'>
          ...
          <button className='px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-700 hover:cursor-pointer ml-4'>Log in</button>
        </div>
      </div>
    </div>
  </header>
      ...
      <div className="lg:w-1/2 ">
        ...
        <div className="mt-2 ml-5 flex mt-4">
          <div className="inline-flex rounded-md shadow">
            <button onClick={() => {}} className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
              Get started
            </button>
          </div>
          </div>
